        ...
        <nav className="bg-white shadow fixed top-0 w-full z-10">
            <div className="pl-0  pr-2 sm:px-0">
                <div className="container mx-auto flex h-20 justify-between">
                    <div className="flex">
                        {/* TODO - fix logo dimensions */}
                        <Link href='/' className="-ml-6 flex flex-shrink-0 items-center cursor-pointer">
                            <Image src={logo || ''} alt="RTech Company Logo" className="h-20 w-auto" width={100} height={100} />
                        </Link>
                    </div>
